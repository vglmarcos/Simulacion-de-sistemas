...
if(Manhattan){
    ...
    g <- g + geom_boxplot(stat = "identity") + theme_gray(base_size = 14) + labs(x = "Tama\u{F1}o de la zona (n)", y = "Distancia Manhattan")
    g <- g + scale_fill_brewer(palette="BuGn") + facet_grid(~n) + theme(legend.position="none")
    g
